...
<style>
    ...
    @media(max-width:992px){.hero-grid{grid-template-columns:1fr}.section-header{flex-direction:column;align-items:flex-start}.route-card{flex-direction:column;min-height:auto}.route-image{width:100%;height:200px}.route-body{flex-direction:column;align-items:flex-start;padding:16px 20px}.price{text-align:left;width:100%;padding-left:0;padding-top:8px;border-top:1px solid #f3f4f6}.promo-card h1{font-size:44px}.section-header h2{font-size:38px}}@media(max-width:576px){.promo-card{padding:28px}.promo-card h1{font-size:36px}.section-header h2{font-size:30px}.image-overlay h3{font-size:28px}.subscribe{flex-direction:column}.subscribe input,.subscribe button{width:100%}.route-image{height:160px}.route-body{padding:14px 16px}.route-info h3{font-size:20px}.route-info .route-details{font-size:13px}.new-price{font-size:24px}}
</style>
@endpush
